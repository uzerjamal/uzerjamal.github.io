    ...
    return(
        <div class="min-w-full min-h-screen bg-gradient-to-br from-blue via-black to-black flex">
            <div class='text-white font-md w-auto lg:w-2/3 ml-20 lg:ml-40 m-auto'>
                ...
                <a href="#Portfolio" class='text-xl' style={{lineHeight:4 +'rem'}}><span class='font-extrabold text-white hover:text-pink transition bg-pink px-4 py-2 hover:bg-white'>RECENT PROJECTS</span></a>
            </div>
